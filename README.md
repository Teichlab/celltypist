...
+ <details>
  ...
  |[add_node](https://celltypist.readthedocs.io/en/latest/celltypist.tree.Tree.html#celltypist.tree.Tree.add_node)                |Add a single node under a given parent node in the tree                        |`tree.add_node(new_node, parent = 'CD4+ T cell')`                                                       |Equivalent to `tree.add_children(new_node, parent = 'CD4+ T cell')`   |
