...
@click.option("-ps", "--p-thres", default=0.5, help="For flat annotation, the probability threshold for multi-label classification. Ignored if `--mode` is `best_match` or `--hierarchical` is enabled.", type=float, show_default=True)
